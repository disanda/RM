...
parser.add_argument('--beta_1', type=float, default=0.5)  #默认是0.5，elr是0.0
...
parser.add_argument('--experiment_name', default='D_lr_noNormACinLastlayer_v2')
...
#--------training D-----------
            ...
            D_loss_dict={'d_loss': x_real_d_loss.item() + x_fake_d_loss.item(), 'gp': gp.item(), 'd_loss_real': x_real_d_loss.item(), 'd_loss_fake': x_fake_d_loss.item()}
...
#-----------training G-----------
            ...
            it_g += 1
            G_loss_dict = {'g_loss_fake': G_loss.item()}
